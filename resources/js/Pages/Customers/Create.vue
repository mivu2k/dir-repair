...
<template>
    ...
    <AuthenticatedLayout>
        <PageHeader title="New Customer" subtitle="Add a new client to the database" />
            ...
            <div class="bg-white border border-border rounded-xl shadow-sm overflow-hidden">
                <form @submit.prevent="submit" class="p-8 space-y-6">
                    ...
                    <div class="pt-6 border-t border-border flex justify-end gap-4">
                        <button type="button" @click="$inertia.visit(route('customers.index'))" class="px-6 py-2 rounded-lg text-sm font-medium text-zinc-600 hover:bg-zinc-50 transition-colors">
                            Cancel
                        </button>
