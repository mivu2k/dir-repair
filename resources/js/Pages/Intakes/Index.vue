    ...
    <AuthenticatedLayout>
        <div class="space-y-4">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex items-center gap-2 w-full sm:w-auto sm:max-w-md justify-end">
                    <div class="relative flex-1 max-w-xs">
                        <input 
                            v-model="search" 
                            type="text" 
                            placeholder="Search intakes..." 
                            class="input-field py-1.5 w-full"
                    ...
                    <Link :href="route('intakes.create')" class="btn-primary py-1.5 px-4 text-[10px] uppercase font-black tracking-widest whitespace-nowrap">New Intake</Link>
                </div>
            </div>
